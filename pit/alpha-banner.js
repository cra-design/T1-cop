...
alphaBanner.insertAdjacentHTML('afterbegin', '<section class="experimental alpha-top bg-warning mrgn-tp-0 mrgn-bttm-0" role="banner"><div class="container"><p class="h2">This site is for CRA testing only</p></div></section >');
